export const AUTH_CONFIG = {
  domain: process.env.REACT_APP_DATAWARE_TOOLS_AUTH_CONFIG_DOMAIN
  ...
  clientId: process.env.REACT_APP_DATAWARE_TOOLS_AUTH_CONFIG_CLIENT_ID
  ...
  apiUrl: process.env.REACT_APP_DATAWARE_TOOLS_AUTH_CONFIG_API_URL
